#ifndef DISPERSALHIBERNATIVE_H
#define DISPERSALHIBERNATIVE_H

#include "Dispersal.h"
#include "UtilityFunctions.h"

class DispersalHibernative : public Dispersal {
public:
    /** \brief Assigns all parameter values for hibernative dispersal */
    DispersalHibernative( );
